    ...
    class="w-10/12 p-4 mx-auto bg-white rounded-xl">
        ...
        <div class="grid grid-cols-2 rounded-xl bg-white gap-5">
            <div class="col-span-1">
                <img id="preview" class="object-cover rounded-l-xl w-full aspect-video" src="{{$recipe['image']}}" alt="recipe-image">
            ...
            <div class="col-span-1 p-3">
                ...
                <div id="ingredients">
                    @php
                        $old_ingredients = $recipe['ingredients'] ?? null;
                    @endphp
                    ...
                    <div class="ingredient flex items-center mb-4">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 ml-3 cursor-pointer">
            ...
            <div id="steps">
                @foreach ($recipe['steps'] as $i=> $os)
                    <div class="step flex justify-between items-center mb-2">
                        ...
                        <input type="text" name="steps[]" value="{{$os['description']}}" placeholder="レシピの作り方を入力してください。手順は三本線ドラッグして移動できます。" class="border border-gray-300 py-2 w-full rounded-xl">                        
